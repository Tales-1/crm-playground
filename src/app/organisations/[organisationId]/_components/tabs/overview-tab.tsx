        ...
        <div className="bg-card rounded-lg border border-outline p-4">
          ...
          <div className="space-y-3">
            ...
            {organisation.website && (
              <div className="flex items-center">
                <Globe className="h-4 w-4 text-muted mr-2" />
                <a
            ...
            <div className="flex items-center">
              <Building className="h-4 w-4 text-muted mr-2" />
        ...
        <div className="bg-card rounded-lg border border-outline p-4">
          ...
          <div className="space-y-2">
            ...
            {organisation.contacts.length === 0 && (
              <p className="text-sm text-muted py-2">No contacts added yet</p>
            )}
          </div>
        </div>
        ...
        <div className="bg-card rounded-lg border border-outline p-4">
          ...
          <div className="space-y-2">
            {organisation.deals
              .filter(
                (deal) =>
                  !["closed-won", "closed-lost"].includes(deal.stageTitle)
              )
              .slice(0, 2)
              .map((deal) => (
            ...
            {organisation.deals.filter(
              (deal) => !["closed-won", "closed-lost"].includes(deal.stageTitle)
            ).length === 0 && (
              <p className="text-sm text-muted py-2">No active deals</p>
            )}
          </div>
        </div>
