                    ...
                    <div className="space-y-3">
                        {organisation.email && (
                            <div className="flex items-center">
                                <Mail className="h-4 w-4 text-crm-muted mr-2" />
                                <a href={`mailto:${organisation.email}`} className="text-sm hover:text-crm-accent">
                                    {organisation.email}
                                </a>
                            </div>
                        )}
                        ...
                        {organisation.phone && (
                            <div className="flex items-center">
                                <Phone className="h-4 w-4 text-crm-muted mr-2" />
                                <a href={`tel:${organisation.phone}`} className="text-sm hover:text-crm-accent">
                                    {organisation.phone}
                                </a>
                            </div>
                        )}
                        ...
                        {organisation.website && (
                            <div className="flex items-center">
                                <Globe className="h-4 w-4 text-crm-muted mr-2" />
                                <a href={organisation.website} target="_blank" rel="noopener noreferrer" className="text-sm hover:text-crm-accent">
                        ...
                        <div className="flex items-center">
                            <Building className="h-4 w-4 text-crm-muted mr-2" />
                ...
                <div className="bg-crm-card/50 rounded-lg border border-crm-border-light p-4">
                    ...
                    <div className="space-y-2">
                        ...
                        {organisation.contacts.length === 0 && (
                            <p className="text-sm text-crm-muted py-2">No contacts added yet</p>
                        )}
                    </div>
                </div>
                ...
                <div className="bg-crm-card/50 rounded-lg border border-crm-border-light p-4">
                    ...
                    <div className="space-y-2">
                        ...
                        {organisation.deals.filter(deal => !['closed-won', 'closed-lost'].includes(deal.stageTitle)).length === 0 && (
                            <p className="text-sm text-crm-muted py-2">No active deals</p>
                        )}
                    </div>
                </div>
